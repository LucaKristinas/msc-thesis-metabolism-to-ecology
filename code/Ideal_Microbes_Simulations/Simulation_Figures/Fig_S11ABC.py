...
# ════════════════════════════════════════════════════════════════
# 2. Data Import & Helper Function
# ════════════════════════════════════════════════════════════════

Deng_df = pd.read_csv("SourceData/Deng_glc_biomass_clean.csv")
OFV_df = pd.read_csv("SourceData/E_coli_core_sim_OFVs_Glc_meta.csv", sep=';')
EFV_df = pd.read_csv("SourceData/E_coli_core_sim_EFVs_Glc_meta.csv", sep=';')
...
#--------------------------------------------------------------------------------------------------------
# Generate Data for Plot (smoothed)
#--------------------------------------------------------------------------------------------------------
...
ax1.set_ylabel("Glucose [g/L]", fontsize=14)
ax1.set_xlabel("Time [h]", fontsize=14)
ax1.set_xlim(0, 12)
ax1.set_ylim(0, 2.5)
ax1.tick_params(axis='both', labelsize=14)
ax1.set_title("Empirical Data", fontsize=16)
fig_emp.canvas.draw()
...
ax1r.set_ylim(0, 1)
ax1r.set_ylabel("Biomass [gCDW/L]", fontsize=14)
ax1r.tick_params(axis='y', labelsize=14)

plt.tight_layout()
plt.savefig("Fig_S11C.svg", dpi=300, bbox_inches='tight')
plt.savefig("Fig_S11C.png", dpi=300, bbox_inches='tight')
plt.show()
plt.close(fig_emp)
...
ax2.set_ylabel("Glucose [g/L]", fontsize=14)
ax2.set_xlim(0, 3)
ax2.set_ylim(0, 2.5)
ax2.set_title("EFV Simulation", fontsize=16)
...
ax2r.set_ylim(0, 1)
ax2r.tick_params(axis='y', labelsize=14)
ax2r.set_ylabel("Biomass [gCDW/L]", fontsize=14)

plt.tight_layout()
plt.savefig("Fig_S11A.svg", dpi=300, bbox_inches='tight')
plt.savefig("Fig_S11A.png", dpi=300, bbox_inches='tight')
plt.show()
plt.close(fig_efv)
...
ax3.set_ylabel("Glucose [g/L]", fontsize=14)
ax3.set_xlim(0, 3)
ax3.set_ylim(0, 2.5)
ax3.set_title("OFV Simulation", fontsize=16)
...
ax3r.plot(sim_data["ofv"]["smooth"]["cdw"]["time"], sim_data["ofv"]["smooth"]["cdw"]["value"],
          color=color_cdw, linewidth=3)
ax3r.set_ylim(0, 1)
ax3r.tick_params(axis='y', labelsize=14)
ax3r.set_ylabel("Biomass [gCDW/L]", fontsize=14)

plt.tight_layout()
plt.savefig("Fig_S11B.svg", dpi=300, bbox_inches='tight')
plt.savefig("Fig_S11B.png", dpi=300, bbox_inches='tight')
plt.show()
plt.close(fig_ofv)
...
plt.savefig("Fig_S11_legend.svg", dpi=300, bbox_inches='tight')
plt.savefig("Fig_S11_legend.png", dpi=300, bbox_inches='tight')
plt.show()
plt.close(fig_leg3)
